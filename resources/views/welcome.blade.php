...
<body class="bg-gray-50 text-gray-800 antialiased bg-topography">
    ...
    <section class="max-w-7xl mx-auto px-6 py-12">
        <div class="bg-emerald-800 rounded-3xl p-10 lg:p-14 flex flex-col lg:flex-row justify-between items-center text-white shadow-xl relative overflow-hidden">
