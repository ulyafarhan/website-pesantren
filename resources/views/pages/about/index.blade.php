                ...
                @foreach($facilities ?? [] as $facility)
                    <div class="text-center group">
                        <div class="overflow-hidden rounded mb-6 shadow-sm">
                            <img src="{{ $facility->image_url }}" loading="lazy" alt="{{ $facility->name }}" onerror="this.src='https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=600&q=80';" class="w-full h-56 object-cover group-hover:scale-105 transition duration-500">
                        </div>
