...
<div class="relative w-full whitespace-normal break-words rounded-xl border border-blue-gray-50 bg-white p-6 font-sans shadow-lg shadow-blue-gray-500/10 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col h-full">
    <div class="mb-3 flex items-center gap-3">
        <h3 class="block font-sans text-lg font-bold leading-relaxed tracking-normal text-slate-900 antialiased transition-colors hover:text-emerald-600">
            {{ $program->name }}
        </h3>
    ...
    <p class="block font-sans text-sm font-normal leading-relaxed text-gray-600 antialiased mb-6 flex-grow">
        {{ $program->description }}
    </p>

    <div class="flex items-center gap-5 border-t border-blue-gray-50 pt-4 mt-auto">
