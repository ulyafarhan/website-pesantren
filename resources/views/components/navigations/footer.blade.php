...
<footer class="bg-emerald-950 text-emerald-200 border-t border-emerald-900 mt-20 relative z-10">
    <div class="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm">
                <li><a href="{{ route('home') }}" class="hover:text-amber-400 transition flex items-center gap-2">&rarr; Beranda</a></li>
                <li><a href="{{ route('programs.index') }}" class="hover:text-amber-400 transition flex items-center gap-2">&rarr; Program Kelas</a></li>
                <li><a href="{{ route('facilities.index') }}" class="hover:text-amber-400 transition flex items-center gap-2">&rarr; Fasilitas</a></li>
                <li><a href="{{ route('galleries.index') }}" class="hover:text-amber-400 transition flex items-center gap-2">&rarr; Galeri</a></li>
                <li><a href="{{ route('articles.index') }}" class="hover:text-amber-400 transition flex items-center gap-2">&rarr; Berita & Artikel</a></li>
            </ul>
        </div>
    ...
    <div class="border-t border-emerald-900 py-6">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-xs text-emerald-400 gap-4">
            <p>&copy; {{ date('Y') }} {{ $settings->site_name ?? 'Pesantren Kita' }}. Hak Cipta Dilindungi.</p>
            <div class="flex gap-4">
                <a href="{{ route('ppdb.register') }}" class="hover:text-white transition">Pendaftaran PPDB</a>
                <span>|</span>
