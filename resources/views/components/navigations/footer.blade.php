        ...
        <div class="lg:col-span-2">
            <div class="flex items-center gap-2 mb-4">
                <img class="h-10 w-auto object-contain" 
                    ...
                    <span class="font-bold text-lg leading-none tracking-tight text-white">
    ...
    <div class="border-t border-emerald-900 py-6">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-xs text-emerald-400 gap-4">
            ...
            <div class="flex gap-4">
                ...
                <span>|</span>
                <a href="{{ route('ppdb.check') }}" wire:navigate class="hover:text-white transition">Cek Status</a>
                <span>|</span>
