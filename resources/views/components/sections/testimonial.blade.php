    ...
    <div class="max-w-7xl mx-auto relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($testimonials as $testi)
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-emerald-100 relative flex flex-col h-full transition-transform hover:-translate-y-1 duration-300">
